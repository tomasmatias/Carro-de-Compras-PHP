...
class Trabajo
  {
   ...
   // metodo para redireccionar cuando no se haga GET.
    ...
    public function getProductosPorId($id=null){
            ...
            $id=(int)$id;
          // validacion para que solo se pueda entrar a archivo pro.php via get si no se redirecciona llamando al metodo _redirect();.
